        ...
        PseudoInfiniteViewport.Pannable
{
   ...
   // private World world;
     ...
     * empty.
     */
    public GridPanel(DisplayMap map, ResourceBundle res, String worldType)
    {
	...
	public void paintComponent(Graphics g)
    {
        ...
        try {
        	switch(worldType)
        	{
        	case "Day": img = ImageIO.read(new File("normalWhite.jpg")); break;
        	case "Underwater": img = ImageIO.read(new File("underwater.jpg")); break;
        	case "Haunted House": img = ImageIO.read(new File("hauntedhouse.jpg")); break;
        	case "Castle": img = ImageIO.read(new File("cartoon.jpg")); break;
        	case "Volcano": img = ImageIO.read(new File("lava.jpg")); break;
        	case "Sky": img = ImageIO.read(new File("cloud.jpg")); break;
        	}
                } catch (IOException e) {
        }
    ...
    public void setGrid(Grid<?> gr)
    {
        ...
        if(worldType.equals("Haunted House"))
        {
        	this.zoomIn(1.03);
        }
        if(worldType.equals("Day"))
        {
        	this.zoomIn(1.93);
        }
        else
